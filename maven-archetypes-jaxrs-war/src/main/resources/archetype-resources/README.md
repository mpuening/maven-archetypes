...
| Command | URL |
| --------------------------- | ---------------------------------------------- |
| mvn -P liberty liberty:run  | http://localhost:9080/${artifactId}/index.html |
| mvn -P wildfly cargo:run    | http://localhost:8080/${artifactId}/index.html |
| mvn -P glassfish cargo:run  | http://localhost:8080/${artifactId}/index.html |
| mvn -P tomee tomee:run      | http://localhost:8080/${artifactId}/index.html |
...
```
curl --verbose http://localhost:8080/${artifactId}/api/ping

curl --verbose --user alice:password http://localhost:8080/${artifactId}/api/me
```
